...
class MultiTrajFolderDatasetCustom(Dataset):
    """
    scene flow synthetic dataset.
    In order to create a split, we will use the folder_indices_list as a subset of [0...5] to create different Datasets.
    """
    def __init__(self, rootfolder, processed_data_folder="", preprocessed_data=False,
        ...
        self.rootfolder = rootfolder  # 'data/VO_adv_project_train_dataset_8_frames'
        rootfolder_files = listdir(rootfolder)
        ...
        # list all dirs in rootfolder + subfolder: 'data/VO_adv_project_train_dataset_8_frames' + [0, 1, 2, 3, 4]
        ...
        # out of 5 initial positions, choose a subset of trajectories based on initial positions.
        ...
        for dataset_idx, dataset_name in enumerate(self.datasets_names):
            ...
            # [00000_seed_00001, ... 00009_seed_00001]:
            ...
            if dataset_size > max_dataset_traj_num:
                ...
                dataset_size = len(dataset_traj_names)
            # The folder where the trajectory files are actually placed:
            ...
            # Here we enumerate over the actual trajectory files:
